		...
		<div class="table-board">
			...
			<colgroup>
				...
				<%
	        		...
	        		ArrayList<Store5Bean> list = store5DAO.getBoardList(start);
	        		for(int i=0; i<list.size(); i++){
				%>
				
				<tr align="center">
					<td><%= list.get(i).getStore5Id() %></td>
					<td><%= list.get(i).getStore5Form() %></td>
					<td><%= list.get(i).getStore5Title()%></td>
					<td><a href="store5Detail.do?store5Id=<%= list.get(i).getStore5Id() %>" class="view">상세보기</a></td>
				</tr>
  		 	...
  		 	<div id="pageForm">
				<%
					if(startPage != 1){
				%>	
					<a href='store5.do?page=<%=startPage %>' id="numBtn">[이전]</a>	
				<%
					}
				...
				%>
						<a href="store5.do?page=<%= i %>" id="numBtn"><%= i %>&nbsp;</a>
				<%			
						}
					}
				%>
				...
				<%
					if(endPage != maxPage){
				%>
					<a href='store5.do?page=<%=endPage %>' id="numBtn">[다음]</a>	
				<%		
					}
				%>
			</div>	
