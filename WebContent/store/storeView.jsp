        ...
        <div class="row">
          <div class="col-lg-12">
          	...
          	<%
            	if(id!=null){
            %>
            <h3 class="section-heading text-muted" align="right"><a href="store/storeWrite.jsp" class="click_a">글쓰기<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a></h3>
          	<%
            	}
          	%>
            <hr>
			...
			<div class="col-lg-12 store-item">
              <img class="img-fluid" src="../UploadFolder/Store1/<%= store.getStore1File1() %>">
            ...
            <div class="info">
				...
				<p id="mapText"> 지도에서 위치 보기</p>
					<div class="col-lg-12">
						 <img class="img-fluid" src="../UploadFolder/Store1/<%= store.getStore1File2() %>">
					</div>
	             	  </div>
           		   </div>
    	       </div>
