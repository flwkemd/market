      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#store">상점소개</a>
            </li>
            <li class="nav-item">
  ...
  <div class="container">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              ...
              <div class="carousel-caption d-none d-md-block">
                ...
                <p class="text-shadow">첫번째 슬라이드 사진 입니다..</p>
              </div>
            </div>
            <div class="carousel-item">
              ...
              <div class="carousel-caption d-none d-md-block">
                ...
                <p class="text-shadow">2번째 사진입니다..</p>
              </div>
            </div>
            <div class="carousel-item">
              ...
              <div class="carousel-caption d-none d-md-block">
                ...
                <p class="text-shadow">3번째 슬라이드 입니다.</p>
              </div>
            </div>
          </div>
    ...
    <section class="bg-light" id="store">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-left">
          	<h2 class="section-heading"><span class="text"><a href="#">상점 소개</a></span></h2>
          	<h3 class="section-heading text-muted" align="right"><a href="#" class="click_a">더보기<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a></h3>
            <hr>
          </div>
        </div>
        <div class="row">
    ...
    <section class="bg-light" id="search">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-left">
            <h2 class="section-heading"><span class="text"><a href="#">재료 검색</a></span></h2>
          	<h3 class="section-heading text-muted" align="right"><a href="#" class="click_a">더보기<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a></h3>
            <hr>
