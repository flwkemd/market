		...
		<div class="table-board">
			...
			<colgroup>
				...
				<%
	        		...
	        		ArrayList<Store4Bean> list = store4DAO.getBoardList(start);
	        		for(int i=0; i<list.size(); i++){
				%>
				
				<tr align="center">
					<td><%= list.get(i).getStore4Id() %></td>
					<td><%= list.get(i).getStore4Form() %></td>
					<td><%= list.get(i).getStore4Title()%></td>
					<td><a href="store4Detail.do?store4Id=<%= list.get(i).getStore4Id() %>" class="view">상세보기</a></td>
				</tr>
  		 	...
  		 	<div id="pageForm">
				<%
					if(startPage != 1){
				%>	
					<a href='store4.do?page=<%=startPage %>' id="numBtn">[이전]</a>	
				<%
					}
				...
				%>
						<a href="store4.do?page=<%= i %>" id="numBtn"><%= i %>&nbsp;</a>
				<%			
						}
					}
				%>
				...
				<%
					if(endPage != maxPage){
				%>
					<a href='store4.do?page=<%=endPage %>' id="numBtn">[다음]</a>	
				<%		
					}
				%>
			</div>	
